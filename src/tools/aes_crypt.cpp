...
//m_prng.GenerateBlock(m_iv, AES::BLOCKSIZE);
	...
	hmac.CalculateDigest(digest, reinterpret_cast<unsigned char *>(&finalBuff[SHA256::DIGESTSIZE]),
											 finalBuff.size() - SHA256::DIGESTSIZE);
